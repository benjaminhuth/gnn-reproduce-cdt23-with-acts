...
sshpass -p "$CERN_PSWD" scp bhuth@lxplus.cern.ch:$MMD_FILE ./data/
sshpass -p "$CERN_PSWD" scp bhuth@lxplus.cern.ch:$MMT_FILE ./data/
sshpass -p "$CERN_PSWD" scp bhuth@lxplus.cern.ch:$DUMP_FILE ./data/

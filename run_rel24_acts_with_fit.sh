...
export PYTHONPATH=$HOME/itk-gen1/itk_geometry/scripts:$PYTHONPATH
...
$PREFIX python3 scripts/module_map_pipeline.py "$@" \
    ...
    --fit \
    --itk-pixel-data $HOME/itk-gen1/itk_geometry/ITKPixels.db \
    --itk-strip-data $HOME/itk-gen1/itk_geometry/ITKStrips.db \
    --itk-material-map $HOME/itk-gen1/itk_geometry/itk_material_map.root

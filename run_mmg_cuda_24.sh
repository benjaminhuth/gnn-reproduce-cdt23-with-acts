...
$HOME/gnn/ModuleMapGraph/bin/GraphBuilder.cu.exe -j1 -n1 \
	--input-dir=$HOME/gnn/reproduce_cdt23/tmp/rel24/feature_store/trainset \
	--input-csv=1 \
	--input-filename-pattern=event \
	--input-module-map=$HOME/gnn/reproduce_cdt23/rel24/data/ModuleMap_rel24_ttbar_v5_89809evts \
	--gpu-nb-blocks=512 \
	--min-pt-cut=1 \
	--output-dir=. \
	--extra-features=0 \
